...
class LogManager:
    ...
    def get_log_file_info(self, project: ProjectInfo, log_date: date = None) -> LogFileInfo:
    ...
    def save_log(self, log_info: LogFileInfo, log_data: LogData, other_at_end: bool = False):

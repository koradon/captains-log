...
class EntryProcessor:
    ...
    def update_commit_entries(self, entries: List[str], new_sha: str, new_message: str) -> List[str]:
    ...
    def organize_repos_for_output(self, repos: Dict[str, List[str]], 
                                 other_at_end: bool = False) -> Dict[str, List[str]]:

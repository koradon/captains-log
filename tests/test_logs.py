...
from src.logs import LogData, LogFileInfo, LogParser, LogWriter, LogManager
...
def test_log_manager_get_log_file_info_global_repo():
    ...
    project = ProjectInfo(name="test-project", config=project_config, base_dir=Path("/tmp/project"))
...
def test_log_manager_get_log_file_info_project_specific():
    ...
    project_config = ProjectConfig(
        ...
        log_repo=Path("/tmp/project-logs")
    )
    project = ProjectInfo(name="test-project", config=project_config, base_dir=Path("/tmp/project"))
...
def test_log_manager_load_log(tmp_path):
    ...
    log_file.write_text("""# What I did

...
def test_hook():
    ...
    print(f"Testing Captain's Log hook with:")
    ...
    try:
        ...
        result = subprocess.run([
            ...
            repo_name, str(repo_path), commit_sha, commit_msg
        ...
        for line in output_lines:
            if not line.startswith('On branch') and not line.startswith('Your branch') and not line.startswith('Untracked files'):
                print(line)
